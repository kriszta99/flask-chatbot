# Rólunk
A Sapientia Erdélyi Magyar Tudományegyetem a romániai magyarság önálló egyeteme Európában, melynek célja nemzeti közösségünk oktatásának és tudományos életének elismert szakmai színvonalon való művelése.```markdown
...
Könyvtár (https://ms.sapientia.ro/hu/a-karrol/rolunk/munkatarsak/konyvtar__)```markdown
...
Nagy Csilla könyvtáros (https://ms.sapientia.ro/hu/a-karrol/rolunk/munkatarsak/konyvtar__/nagy-csilla)```markdown
# Szervezeti ábra
...
Választások (https://ms.sapientia.ro/hu/a-karrol/a-kar-vezetese/valasztasok)```markdown
...
* Biblia Csilla, kari Erasmus-koordinátor```markdown
...
*   dr. Hajdu Szabolcs, rendszergazda```markdown
...
* Pap Hunor, hallgató
* Szabó Nikoletta Laura, hallgató```markdown
...
*   Szántó Emese - tanszéki titkár```markdown
...
Bálint Lajos szakmunkás (https://ms.sapientia.ro/hu/a-karrol/tanszeke/gepeszmernoki-tanszek/balint-lajos)Oké, íme a tisztított markdown szöveg, a kéréseknek megfelelően:
